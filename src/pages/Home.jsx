...
export default function Home() {
  ...
  return (
    ...
    <img src="src\assets\home-bg.png" alt="background img" className="w-[70%]  h-[30%] sm:h-[60%] lg:h-[80%]" />
    ...
    <main className="flex flex-col items-start justify-start text-left px-4 sm:px-10 lg:px-20">
          ...
          <div className="mt-[180px] sm:w-fit lg:space-x-10  flex flex-col sm:flex-row gap-6">
